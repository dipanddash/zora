      ...
      <div className="relative bg-[#0a041f]/80 backdrop-blur-3xl border border-purple-700/40 rounded-[50px] p-8 sm:p-10 md:p-16 shadow-[0_0_80px_rgba(124,58,237,0.5)]">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
          ...
          <div className="order-2">
            ...
            <Link
              to="/services/non-it"
              className="inline-block mt-8 sm:mt-10 px-10 sm:px-12 py-4 rounded-2xl font-semibold bg-gradient-to-r from-purple-700 to-blue-700 hover:scale-105 transition duration-300 shadow-[0_0_30px_rgba(124,58,237,0.8)]"
            >
